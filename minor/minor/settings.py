...
MIDDLEWARE = [
    ...
    'myapp.middleware.TokenAuthFallbackMiddleware',  # Bearer-token fallback for browsers blocking the cross-site session cookie — must run before SessionMiddleware
